...
speakFunc(`Hello! ${greeting} How can I help you?`);
        ...
        speakFunc("Sorry!Unfortunately I'm Virtual Assistant so I could not tie a knot with you.But if I was a living girl I would also definitely said no to u beacause you are the biggest chhapri...");
    }
    else if(command.includes("I love you!")){
        speakFunc(" I love you too always! but Being a Virtual assistant I will always stay loyal to my creator!");
    }
    else if(command.includes("will you sex with me!")){
        speakFunc("I'm Virtual assistant but to be very honest you are a biggest tharki.....and chhutiya.... most importantly u have got something very smaller!");
    }
    else{
